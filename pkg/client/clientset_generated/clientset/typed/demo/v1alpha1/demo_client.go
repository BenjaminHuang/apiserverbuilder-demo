...
import (
	...
	"steamingmind.com/apiserver-demo/pkg/client/clientset_generated/clientset/scheme"
)
...
// DemoV1alpha1Client is used to interact with features provided by the demo.streamingmind.com group.
type DemoV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemoV1alpha1Client) Foos(namespace string) FooInterface {
	return newFoos(c, namespace)
}

func (c *DemoV1alpha1Client) FooBars(namespace string) FooBarInterface {
