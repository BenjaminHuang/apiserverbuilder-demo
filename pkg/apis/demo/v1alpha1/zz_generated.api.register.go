...
var (
	ApiVersion = builders.NewApiVersion("demo.streamingmind.com", "v1alpha1").WithResources(
		demo.DemoFooStorage,
		builders.NewApiResource( // Resource status endpoint
			demo.InternalFooStatus,
			...
			&demo.FooStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
			...
			func(generic.RESTOptionsGetter) rest.Storage {
				return &demo.FooBarREST{Registry: demo.NewFooRegistry(demo.DemoFooStorage)}
			},
		),
	)
