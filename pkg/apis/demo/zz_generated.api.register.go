...
var (
	DemoFooStorage = builders.NewApiResource( // Resource status endpoint
		InternalFoo,
		...
		&FooStrategy{builders.StorageStrategySingleton},
	)
	...
	ApiVersion = builders.NewApiGroup("demo.streamingmind.com").WithKinds(
		InternalFoo,
		InternalFooStatus,
		InternalFooBarREST,
	)
